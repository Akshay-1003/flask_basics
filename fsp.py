...
app.config.update(
    ...
    SQLALCHEMY_DATABASE_URI='postgresql://postgres:asususer@localhost/catlog_db',
...
@app.route('/watch/')
def top_movies():
    movie_list=['Avengers-age of ultron','Punisher','Gravity', 'Janta Garage', 'Scam1992','john wick']
    return render_template('movies.html',movies=movie_list,name='Akshay')
...
@app.route('/tables')
def movies_plus():
    movies_dict = {'Avengers-age of ultron':01.14,'Punisher':3.22,'Gravity':1.32, 'Janta Garage':2.22, 'Scam1992':3.56,
                    'john wick':4.23}
